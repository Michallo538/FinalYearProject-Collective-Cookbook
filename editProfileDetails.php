...
<!-- PHP For saving/Editing the details -->
<?php
...
if (isset($_REQUEST['update_profile'])) {
    ...
    $sqlSave = ("UPDATE user SET Firstname = '$Firstname',
                                 Lastname = '$Lastname',
                                 about = '$about',
                                 Gender = '$about',w
                                 email = '$Email'
    ...
    header("Location: viewProfileOwn.php?info=detailsUpdated");
}
?>
            ...
            <div class="mx-5 my-3 rounded bg-info rounded fluid-container rrow">
                ...
                <div class="bg-info column text-center form-group">
                    ...
                    <div class="d-inline-flex">
                        ...
                        <input class="text-center form-control" name="firstname" type="text" value="<?php echo $row['Firstname'] ?>">
                        <input class="text-center form-control" name="lastname" type="text" value="<?php echo $row['Lastname'] ?>">
                    </div>
                    <br>
                    <div>
                ...
                <div class="column">
                    <div>
                        ...
                        <textarea id="abouttxt" class="form-control mb-2" type="text" name="about" cols="20" rows="5" placeholder="We don't know anything about you, add something here for us to get to know you little better!"></textarea>
                    </div>
                    <div>
                        <label class="form-label">Account Created:</label><br>
                        <input disabled name="datetime" type="datetime" class="form-control" name="AccountDateTime" value="<?php echo $row['create_datetime']; ?> ">
                    </div>
                    <div>
                        <label for="gender" class="form-label">Gender</label>
                        <input enabled name="gender" type="text" class="form-control" name="gender" value="<?php echo $row['Gender']; ?>">
                    </div>
                ...
                <div class="fluid-container text-center">
                    <button name="update_profile" class="btn btn-dark">Save</button>

                    <a class="btn btn-dark" href="viewProfileOwn.php?UserID=<?php echo $UserID; ?>">Cancel</a>
                </div>
